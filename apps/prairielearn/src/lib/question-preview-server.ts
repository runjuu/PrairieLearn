...
/**
 * Checks whether a request path belongs to the generated-files asset route.
 *
...
/**
 * Handles requests for startup-course assets such as `clientFilesCourse`,
 * elements, element extensions, and question-local client files.
 *
 * @param params - Asset route inputs.
 * @param params.options - Preview-server options, including the startup course.
 * @param params.req - Incoming asset request.
 * @param params.res - Express response used to send the asset.
 */
async function handleStartupCourseAssetRequest(params: {
  options: QuestionPreviewServerOptions;
...
/**
 * Handles requests for files generated by a particular preview render.
 *
 * @param params - Generated-file route inputs.
 * @param params.generatedFilesRoot - Temp root containing render-ID directories.
 * @param params.req - Incoming generated-file request.
 * @param params.res - Express response used to send the asset.
 */
async function handleGeneratedFilesAssetRequest(params: {
  generatedFilesRoot: string;
  req: http.IncomingMessage;
  res: Response;
}) {
